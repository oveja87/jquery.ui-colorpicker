	...
	_create: function(){
		...
		if( type == 'bar'){
			var container = div
			  ...
			  ,	colorbar = div
			  		.clone()
			  		.attr( 'id', 'hsb_colorbar' )
					.appendTo( container )
					.slider( { max:360, orientation: 'vertical' } )
			  ;			
